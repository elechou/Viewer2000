...
//-----------------------------------------------------------------------------
#ifndef V2K_ISR_HZ
#define V2K_ISR_HZ          V2K_BOARD_PROFILE_CONTROL_HZ
#endif

// The selected board profile owns the clock facts. The hardware-contract gate
// pins the corresponding SysConfig clock/period values, and board read-back
// verifies the generated configuration before outputs can be released.
#define V2K_EPWMCLK_HZ      V2K_BOARD_PROFILE_EPWMCLK_HZ
...
#define V2K_CPUTIMER_HZ     V2K_BOARD_PROFILE_CYCLE_COUNTER_HZ
